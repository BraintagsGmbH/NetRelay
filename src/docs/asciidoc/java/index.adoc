...
* encoders
If you are using the annotation `link:../../apidocs/de/braintags/io/vertx/pojomapper/annotation/field/Encoder.html[@Encoder]` inside your
...
implements `link:../../apidocs/de/braintags/io/vertx/util/security/crypt/IEncoder.html[IEncoder]` and some optional properties, which are used by
