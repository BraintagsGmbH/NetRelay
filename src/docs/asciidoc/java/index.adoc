...
or processors
* the datastore settings to define, which `link:../../apidocs/de/braintags/vertx/jomnigate/IDataStore.html[IDataStore]` shall be used by
...
* encoders
If you are using the annotation `link:../../apidocs/de/braintags/vertx/jomnigate/annotation/field/Encoder.html[@Encoder]` inside your
...
implements `link:../../apidocs/de/braintags/vertx/util/security/crypt/IEncoder.html[IEncoder]` and some optional properties, which are used by
...
`link:../../apidocs/de/braintags/vertx/keygenerator/KeyGeneratorVerticle.html[KeyGeneratorVerticle]` from the project
